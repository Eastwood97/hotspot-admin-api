...
public interface PermissionMapper {
     ...
     * @mbg.generated
     */
    Permission selectByPrimaryKeySelective(@Param("id") Long id, @Param("selective") Permission.Column ... selective);
     ...
     * @mbg.generated
     */
    Permission selectByPrimaryKeyWithLogicalDelete(@Param("id") Long id, @Param("andLogicalDeleted") boolean andLogicalDeleted);
